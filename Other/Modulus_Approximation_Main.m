...
% Data from Figi
file = 'D:\Université\Matrise\Article\DataOutput\L3_200x.xlsx';
Data = xlsread(file);
...
for i = 1 : n  
    % Phi color
    z1(i,:) = colorPhi(find(div>Phi(i),1)-1,:);
end
