...
% DLF composite
file = 'D:\Université\Matrise\Article\DataOutput\R1_200x.xlsx';
Gamma = 45; 
E1 = 135e9;% Pa
...
%     Distance = y(i) - Mid;
    ...
    % Matrice B
    Bf = (1/2) * Qbar * (Z1^2 - Z2^2);
    B = B + Bf;
    
    % Matrice D
    Df = (1/3) * Qbar * (Z1^3 - Z2^3);
    D = D + Df;
...
set(hcb,'YTick',div)
axis equal
% axis([0 max(x) -round(max(y)) 0])
axis([0 5.9635e+03 -round(max(y)) 0])
